		...
		if($('#targetLayer').text().indexOf('Yes') >= 0) {
			if($('.fcaption').val() == 0) {
				if($('input[name="falign"]:checked').val() == 'None') {
					...
					$('.imageCode').text('<img align="center" class="pagephoto" src="/clients/' + hn + '/' + $(".fname").val()  + '" />');
				}
				else if($('input[name="falign"]:checked').val() == 'Right') {
					$('.imageCode').text('<img align="right" class="pagephoto" src="/clients/' + hn + '/' + $(".fname").val()  + '" />');
				}
				else if($('input[name="falign"]:checked').val() == 'Left') {
					$('.imageCode').text('<img align="left" class="pagephoto" src="/clients/' + hn + '/' + $(".fname").val()  + '" />');
				}
				else {
					$('.imageCode').text('<img class="pagephoto" src="/clients/' + hn + '/' + $(".fname").val()  + '" />');
				}
