...
$(document).ready(function (e) {
	...
	var sa = setInterval(function () {
		...
		if($('#targetLayer').text().indexOf('Yes') >= 0) {
			if($('.fcaption').val() == 0) {
				$('.cnimg').html('<img class="pagephoto" src="/clients/' + hn + '/' + $(".fname").val()  + '" />');
				$('.imageCode').text('<img class="pagephoto" src="/clients/' + hn + '/' + $(".fname").val()  + '" />');
			}
			else {
				if($('#falign').val() == 'Center') {
					$('.imageCode').text('<table width="1" cellspacing="0" cellpadding="0" border="0" align="Center"><tbody><tr><td align="Center"><span><img class="pagephoto layout_pagephoto" SRC="/clients/'+ hn + '/' + $(".fname").val() + '"></span></td></tr><tr><td><div class="pagephotocaption layout_pagephotocaption ">' + $(".fcaption").val() + '</div></td></tr></tbody></table>');
				}
				if($('#falign').val() == 'Right') {
					$('.imageCode').text('<table width="1" cellspacing="0" cellpadding="0" border="0" align="Right"><tbody><tr><td align="Center"><span><img class="pagephoto layout_pagephoto" SRC="/clients/'+ hn + '/' + $(".fname").val() + '"></span></td></tr><tr><td><div class="pagephotocaption layout_pagephotocaption ">' + $(".fcaption").val() + '</div></td></tr></tbody></table>');
				}
				if($('#falign').val() == 'Left') {
					$('.imageCode').text('<table width="1" cellspacing="0" cellpadding="0" border="0" align="Left"><tbody><tr><td align="Center"><span><img class="pagephoto layout_pagephoto" SRC="/clients/'+ hn + '/' + $(".fname").val() + '"></span></td></tr><tr><td><div class="pagephotocaption layout_pagephotocaption ">' + $(".fcaption").val() + '</div></td></tr></tbody></table>');
				}
			}
			$('#targetLayer').text('No');
				...
				<form id="uploadForm" action="iupload.php" method="post">
					<div id="targetLayer">No</div>
						<div class="cnic">
							...
							<button class="fcopybn" onclick="copyic()">Copy Code</button></div>
							<div id="uploadFormLayer">
								...
								<section class="fsec" style="display:none;">
									<label class="flabel">Caption<br><i>(Optional)</i></label>
									<input name="fcaption" class="fcaption" type="text" value="">
								</section>
								<section class="fsec" style="display:none;">
									<label class="flabel">Alignment<br><i>(Optional)</i></label>
									<select id="falign">
								...
								<input name="hname" class="hname" type="hidden" value="">
								<div class="fbutton">
