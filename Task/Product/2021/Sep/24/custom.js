...
$(document).ready(function() {
    ...
    $(".pc-cart").on("click", function() {
        $(this).each(function() {
            ...
            $("#list-item").append("<li>" + pic + "<div class='productx-name'>" + name + "</div>" + c + cena + remove + weight + sfxx + dscx + "</li>");
