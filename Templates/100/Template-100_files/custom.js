...
$(document).ready(function(){
if ($(window).width() <= 1024) {
$('#cssmenu > ul').css('background-color',$('#cssmenu').parent('div').css('backgroundColor'));
$('#menu-button').css('background-color',$('#cssmenu').parent('div').css('backgroundColor'));
}
});
$(window).bind('load',function(){
if ($(window).width() <= 1024) {
...
$('#cssmenu').css({'height':$(window).height() + 7, 'overflow-y':'auto', 'z-index':'9999', 'top':0, 'position':'fixed','display':'block'});
$('#cssmenu > ul').css({'height' : $(window).height() - $('#menu-button').outerHeight(), 'overflow-y':'auto'});
}, function(){
